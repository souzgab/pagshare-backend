...
public class TransactionRest {
    private final String URL = "https://mercadopagoapi.herokuapp.com/pagar";
    ...
    public ResponseEntity<?> createTransaction(String token, long idUser, BigDecimal amount) {
        ...
        ResponseEntity<TransactionDto> result = restTemplate.exchange("/" + idUser + "/" + amount, HttpMethod.GET,
